...
//        System.out.println();
    ...
    public static void getTest1Structure() throws JCoException
    {
        JCoDestination destination = JCoDestinationManager.getDestination(ABAP_AS);
        JCoFunction function = destination.getRepository().getFunction("ZFI_GET_BKPF");
        if(function == null)
            throw new RuntimeException("ZFI_GET_BKPF not found in SAP.");
        ...
        //System.out.println(function.getImportParameterList().getParameterFieldIterator()
        //System.out.println(function.getExportParameterList().toString());
        
        //System.out.println(function.toString());
        
        JCoParameterList input = function.getImportParameterList();
        JCoFieldIterator itr1 = input.getFieldIterator();
        
        System.out.println("===INPUT===");
        while (itr1.hasNextField()) {
        	JCoField field1 = itr1.nextField();
        	System.out.println(field1.getName());
        }
        
        JCoParameterList output = function.getExportParameterList();
        JCoFieldIterator itr2 = output.getFieldIterator();
        
        System.out.println("===OUTPUT===");
        while (itr2.hasNextField()) {
        	JCoField field2 = itr2.nextField();
    ...
    public static void test1SimpleCall() throws JCoException
    {
        //JCoDestination is the logic address of an ABAP system and ...
        JCoDestination destination = JCoDestinationManager.getDestination(ABAP_AS_POOLED);
        // ... it always has a reference to a metadata repository
        ...
        //containers for import, export, changing and table parameters.
        //To set or get the parameters use the APIS setValue() and getXXX(). 
        //function.getImportParameterList().setValue("IV_BELNR", "0123456789");
        function.getImportParameterList().setValue("IV_BUKRS", "HENC");
        function.getImportParameterList().setValue("IV_GJAHR", "2019");
        ...
        while (itr2.hasNextField()) {
        	JCoField field2 = itr2.nextField();
        	System.out.println(field2.getName() + "=" + field2.getString());
        }
