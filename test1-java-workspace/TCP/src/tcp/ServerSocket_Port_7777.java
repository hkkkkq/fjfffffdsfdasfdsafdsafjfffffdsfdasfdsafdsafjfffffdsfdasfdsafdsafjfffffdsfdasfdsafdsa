...
public class ServerSocket_Port_7777 {
    private ServerSocket server;
    private int port = 9003;

    public ServerSocket_Port_7777() {
        try {
    ...
    public static void main(String[] args) {
        ServerSocket_Port_7777 example = new ServerSocket_Port_7777();
        ...
        try {
        	...
        	while( true ) {
	            ...
	            if( isWrite ) {
		            ...
		            String replyData = "1234567890123456";
		            out.write(replyData);
		            out.flush();
