 ...
 * run     - java -Djavax.net.ssl.trustStore=/home/infadm/truststore -Djavax.net.ssl.trustStorePassword=123456 TCP_SSL_CLIENT
 * debug option - -Djava.protocol.handler.pkgs=com.sun.net.ssl.internal.www.protocol -Djavax.net.debug=ssl
 * @author tmax
 *
 */
public class IOT_HyunCar_TCP_Client_SSL {
