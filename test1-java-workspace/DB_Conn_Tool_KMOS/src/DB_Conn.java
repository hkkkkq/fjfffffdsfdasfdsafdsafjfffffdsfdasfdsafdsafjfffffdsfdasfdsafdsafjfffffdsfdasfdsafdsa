	...
	public static void main(String[] args) throws IOException {
		...
		while (e.hasMoreElements()) {
			...
			try {
				...
				pgds.setLoginTimeout(3000);
				pgds.setServerName(ip);
				pgds.setPortNumber(intPort);
				pgds.setDatabaseName(sid);
				pgds.setUser(id);
				pgds.setPassword(pw);
								
				Connection conn = pgds.getConnection();
								
				String sql = "select to_char(sysdate,'yyyy-mm-dd hh24:mi:ss.ff') from dual;";
