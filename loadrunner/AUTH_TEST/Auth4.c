Auth4()
{
	...
	char* data_ResponseXml_61 = NULL;
	char* data_ResponseXmlENC_61 = NULL;
...
*/
	char checkSum[100];
	 ...
	 if ((data_RequestXml_61 = (char *)calloc(20000, sizeof(char))) == NULL) { 			//6000
		 lr_output_message ("Insufficient memory available"); 
		 return -1; 
	 } 
	
     if ((data_RequestXmlEnc_61 = (char *)calloc(20000, sizeof(char))) == NULL) { 		//6000
        lr_output_message ("Insufficient memory available"); 
        return 0; 
     }

	 if ((data_ResponseXml_61 = (char *)calloc(20000, sizeof(char))) == NULL) { 		//6000
		lr_output_message ("Insufficient memory available"); 
		return 0; 
	 }

	 if ((data_ResponseXmlENC_61 = (char *)calloc(20000, sizeof(char))) == NULL) { 		//6000
		lr_output_message ("Insufficient memory available"); 
		return 0; 
	 }
...
//    lr_save_string((char*)cipherText, "custIdfyNo2"); 
	...
	*/
	...
	lr_end_transaction("4_UserMenuInfoRetvSO", LR_AUTO);
