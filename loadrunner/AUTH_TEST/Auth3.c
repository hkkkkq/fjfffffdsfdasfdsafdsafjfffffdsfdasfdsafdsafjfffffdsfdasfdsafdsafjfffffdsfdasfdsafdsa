Auth3()
{
	...
	char* data_ResponseXml_91 = NULL;
	char* data_ResponseXmlENC_91 = NULL;
...
*/
	char checkSum[100];
	 ...
	 if ((data_RequestXml_91 = (char *)calloc(20000, sizeof(char))) == NULL) { 			//6000
		 lr_output_message ("Insufficient memory available"); 
		 return -1; 
	 } 
	
     if ((data_RequestXmlEnc_91 = (char *)calloc(20000, sizeof(char))) == NULL) { 		//6000
        lr_output_message ("Insufficient memory available"); 
        return 0; 
     }

	 if ((data_ResponseXml_91 = (char *)calloc(20000, sizeof(char))) == NULL) { 		//6000
		lr_output_message ("Insufficient memory available"); 
		return 0; 
	 }

	 if ((data_ResponseXmlENC_91 = (char *)calloc(20000, sizeof(char))) == NULL) { 		//6000
		lr_output_message ("Insufficient memory available"); 
		return 0; 
	 }
...
//    lr_save_string((char*)cipherText, "custIdfyNo2"); 
	...
	*/
	...
	lr_end_transaction("3_UserInfoRetvSO", LR_AUTO);
