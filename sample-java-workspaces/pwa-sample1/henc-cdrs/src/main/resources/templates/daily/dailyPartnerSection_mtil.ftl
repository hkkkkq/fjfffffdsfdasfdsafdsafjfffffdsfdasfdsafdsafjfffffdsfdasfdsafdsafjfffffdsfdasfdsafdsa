<div class="box mtil_box" data-storage_key="mtil">
    <div class="title">
        <a class="data_table_opener" data-toggle="collapse" href="#multiCollapseExample3_${i}" aria-expanded="true" aria-controls="#multiCollapseExample3_${i}">
            <i class="fas fa-caret-right"></i><span>주요자재</span>
        </a><!-- end : title -->
    ...
    <div class="collapse multi-collapse show data_table_wrapper" id="multiCollapseExample3_${i}">
        <div class="btn-toolbar btn-area mtil_btns data_table_actions">
        ...
        <div class="table-list">
            <table class="table data_table mtil_data_table" data-dept_cd="${result.master.deptCd}" data-day="${result.master.day}" data-ordr_no="${result.master.ordrNo}" data-partner_no="${data.ctrc.coprcpNo}" data-ctrc_no="${data.ctrc.ctrcNo}">
                <thead>
                <tr>
                    <th>품명</th>
                    <th>규격</th>
