...
<script src="${ctx_res}/js/ntrm/NTRM0500.js"></script>
    ...
    <div class="main" style="background-color:">
      ...
      <img class="img-cancel" src="${ctx_res}/images/icon-cancel1.png" alt="" style="width:180px; height:180px;">
        <h3>죄송합니다. <br>
          ...
          아래 사유를 확인해주세요.</h3>
          <!--
        <p class="cancel-result" ID="resltMsg">요금정보보험이 필요합니다. 대리점을 방문해주세요.(가입한도 체크)<br>
...
<footer class="footer">
  ...
  -->	
  	<span><img src="${ctx_res}/images/left_home.png" class="img-responsive" id="goHome3"></span>
  	   
  </div>
  <div class="right main">
    <div class="col-sm-2 floatR">
      <button type="button" class="btn btn-page  btn-block" id="goHome5">홈</button>
    </div>
  </div>
</footer>
